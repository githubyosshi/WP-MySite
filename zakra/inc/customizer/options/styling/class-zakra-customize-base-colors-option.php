		...
		public function elements() {
			...
			return array(
				...
				'zakra_base_color_primary' => array(
					'output'    => array(
						array(
							'selector' => 'a:hover, a:focus, .tg-primary-menu > div ul li:hover > a, .tg-primary-menu > div > ul > li.current_page_item > a, 
							.tg-primary-menu > div > ul > li.current-menu-item > a, .entry-content a',
							'property' => 'color',
						),
						array(
