...
require get_template_directory() . '/inc/hooks/slider-main.php';
require get_template_directory() . '/inc/hooks/slider-sec.php';
require get_template_directory() . '/inc/hooks/news-carousel.php';
require get_template_directory() . '/inc/hooks/featured-blog.php';